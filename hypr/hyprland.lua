...
-- Control de brillo
-- hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("busctl --user -- call rs.wl-gammarelay / rs.wl.gammarelay UpdateBrightness d 0.02"), { repeating = true })
-- hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("busctl --user -- call rs.wl-gammarelay / rs.wl.gammarelay UpdateBrightness d -0.02"), { repeating = true })
